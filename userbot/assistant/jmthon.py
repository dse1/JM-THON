...
async def start(event):
    ...
    if event.sender_id == bot.uid:
        await tgbot.send_message(
            vent,
            message=f"**- اهلين عيني الون**\n**- هاذي بعض من اوامرك اختار عبر الازرار بالاسفل ،**\n\n**ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ**\n𝘼𝙡𝙇𝙊𝙉𝙀 𝙐𝙎𝙀𝙍𝘽𝙊𝙏 ♪ ",
            buttons=[
                [
                    Button.url("المطـور ", "https://t.me/C1CiC"),
...
async def settings(event):
    if event.sender_id == bot.uid:
        ...
        await event.answer(
            "انت لا تستطيع استخدام البوت احصل على بوتك من @C1CiC", alert=True
        )
